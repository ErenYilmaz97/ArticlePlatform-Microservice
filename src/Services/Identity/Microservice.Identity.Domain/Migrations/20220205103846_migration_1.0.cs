    ...
    public partial class migration_10 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubscribedClients", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastPasswordUpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Roles_PermissionGroups_PermissionGroupId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserCommonTokens", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserCommonTokens_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Roles_PermissionGroupId",
                table: "Roles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserCommonTokens_UserId",
                table: "UserCommonTokens",
                column: "UserId");
        }
