...
{
    public class EfSubscribedClientRepository : EfRepository<IdentityDbContext, SubscribedClient, string> , ISubscribedClientRepository
    {
        private readonly IdentityDbContext _context;

        public EfSubscribedClientRepository(IdentityDbContext context):base(context)
        {
