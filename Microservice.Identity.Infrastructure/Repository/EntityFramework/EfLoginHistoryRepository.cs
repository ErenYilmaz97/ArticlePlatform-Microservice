...
{
    public class EfLoginHistoryRepository : EfRepository<IdentityDbContext, LoginHistory,long>, ILoginHistoryRepository
    {
        private readonly IdentityDbContext _context;


        public EfLoginHistoryRepository(IdentityDbContext context):base(context)
        {
